...
class ShakeTuneProcess:
    ...
    def _handle_timeout(self) -> None:
        ConsoleOutput.print(
            "Timeout: Shake&Tune computation did not finish within the specified timeout!"
        )
    ...
    def _shaketune_process(self, graph_creator) -> None:
        ...
        try:
            ...
            ConsoleOutput.print(
                "Warning: failed reducing Shake&Tune process priority, continuing..."
            )
        ...
        try:
            ...
            ConsoleOutput.print(
                f"Error while generating the graphs: {e}\n{traceback.print_exc()}"
            )
            return
        ...
        ConsoleOutput.print(
            f"{graph_creator.get_type()} graphs created successfully!"
        )
        ConsoleOutput.print(
