...
class MCU_pwm_in:
    def __init__(self, printer, pin, interval, timeout, pwm_frequency):
    ...
    def build_config(self):
        ...
        timeout_ticks = self._mcu.seconds_to_clock(self._timeout)
        self._mcu.add_config_cmd(
...
class PWMIn:
    def __init__(self, printer, pin, read_interval, pwm_frequency):
        self._callback = None
